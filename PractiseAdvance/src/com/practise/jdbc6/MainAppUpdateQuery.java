...
public class MainAppUpdateQuery {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.print("Enter the new updation sage:: ");
			...
			if (connection != null) {
				...
				if(statement != null) {
					String sqlUpdateQuery = "update student set sage="+sage+" where sid="+sid;
					System.out.println("the query executed by dbe:: "+ sqlUpdateQuery);
					...
					if (rowAffected != 0) {
						System.out.println("No of records update in dB:: " + rowAffected);
					}
				}
			} else {
